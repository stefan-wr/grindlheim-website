...
function preloadimages() {
    ...
    for (var i = 2; i < 7; i++) {
        ...
        newimages[i - 2].src = "{{ site.baseurl }}/assets/img/heros/hero" + i + ".jpg"
...
hero1.src = "{{ site.baseurl }}/assets/img/heros/hero1.jpg"
...
$(window).on("load", function () {
    ...
    preloadimages().done(function (images) {
        for (i = 1; i < 6; i++) {
            ...
            $(".hero-slideshow li:nth-child(" + i + ")").css("background-image", "url({{ site.baseurl }}/assets/img/heros/hero" + (i + 1) + ".jpg)")
        }
